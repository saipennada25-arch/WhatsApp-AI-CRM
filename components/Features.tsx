    ...
    <section id="features" className="py-24 bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-3xl mx-auto mb-16">
          <h2 className="text-brand-600 font-bold tracking-wide uppercase text-sm mb-3">Why UNPHUC?</h2>
          <h3 className="text-3xl md:text-4xl font-extrabold text-gray-900 mb-6">
            The World's Most Advanced AI CRM
          </h3>
          <p className="text-xl text-gray-600">
            Stop manually tagging tickets. Let our Digital Twin handle the busy work while you focus on strategy.
          </p>
        </div>
